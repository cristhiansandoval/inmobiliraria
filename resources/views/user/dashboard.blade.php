                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="box indigo white-text p-30">
                                    ...
                                    <span class="truncate uppercase bold font-18">Commentarios</span>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="box indigo white-text p-20">
                                    ...
                                    <span class="truncate uppercase bold">Comentarios recientes</span>
                                </div>
