...
@section('content')
    ...
    <div hidden>{{DB::table('properties')->where('id', $property->id)->increment('views')}}</div>
    <div hidden>{{DB::table('users')->where('id', $property->agent_id)->increment('views')}}</div>
            ...
            <div class="row">
                <div class="col s12 m8">
                    ...
                    <div class="address m-b-30">
                        <span class="font-18">Se publicó el {{ $property->created_at->format('d/m/Y')}}</span>
                    </div>
                    <div class="address m-b-30">
                    ...
                    <div>
                        ...
                        <span class="btn btn-small disabled b-r-20">Habitaciones: {{ $property->bedroom}} </span>
                        <span class="btn btn-small disabled b-r-20">Baños: {{ $property->bathroom}} </span>
                        <span class="btn btn-small disabled b-r-20">Area: {{ $property->area}} Mts²</span>
                    </div>
                </div>
                <div class="col s12 m4">
                    <div>
                        <h4 class="left">${{ $property->price }}</h4>
                        <button type="button" class="btn btn-small m-t-25 right disabled b-r-20"> En @if($property->purpose=='sale') venta @else alquiler @endif </button>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="single-narebay p-15">
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="content">
                                            <div class="author-name">
                                                ...
                                                @auth
                                                    <span id="commentreplay" class="right replay" data-commentid="{{ $comment->id }}">Responder</span>
                                                @endauth
                            ...
                            @guest 
                                <div class="comment-login">
                                    <h6>Inicie sesion para comentar</h6>
                                    <a href="{{ route('login') }}" class="btn indigo">Iniciar Sesion</a>
                                </div>
                            @endguest
                        ...
                        <div>
                            <ul class="collection with-header m-t-0">
                                ...
                                <li class="collection agent-message">
                                    <a href="https://wa.me/{{$property->user->whatsapp}}?text=Hola,%20me%20interesa%20esta%20propiedad:%20https://inmuebles.frb.io/{{ request()->path() }}" class="agent-message-box">{{$property->user->whatsapp}}</a>
                                </li>
                                <li class="collection-header grey lighten-4">
                                ...
                                <li class="collection agent-message">
                                    <form class="agent-message-box" action="" method="POST">
                                        ...
                                        <div class="box">
                                            <input type="number" name="phone" placeholder="Ingresá tu telefono">
                                        </div>
                                        <div class="box">
                                            <textarea name="message" placeholder="Escribí tu mensaje"></textarea>
                                        </div>
                                        <div class="box">
