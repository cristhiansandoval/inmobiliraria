                ...
                <div class="col s12 m8">
                    ...
                    <div class="card" id="comments">
                        <div class="p-15 grey lighten-4">
                            <h5 class="m-0">{{ $post->comments_count }} Comentarios</h5>
                        </div>
                        <div class="single-narebay p-15">
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="content">
                                            <div class="author-name">
                                                ...
                                                @auth
                                                    <span class="right replay" data-commentid="{{ $comment->id }}">Responder</span>
                                                @endauth
                            ...
                            @guest 
                                <div class="comment-login">
                                    <h6>Acceder para comentar</h6>
                                    <a href="{{ route('login') }}" class="btn indigo">Acceder</a>
                                </div>
                            @endguest
