<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">Publicaciones</h3>
        <ul class="collection">
...
<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">Categorias</h3>
        <ul>
...
<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">Archivos</h3>
        <ul class="collection">
...
<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">Etiquetas</h3>
