                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <label class="form-label">Nro. Habitaciones</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <label class="form-label">Nro. Baños</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="help-info">Metros cuadrados</div>
                    </div>
                    ...
                    <hr>
                    <div class="form-group">
                        <label for="tinymce">Descripcion</label>
                        <textarea name="description" id="tinymce">{{$property->description}}</textarea>
                    </div>

                    <hr>
                    <div class="form-group">
                        <label for="tinymce-nearby">Referecias cercanas</label>
                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('purpose') ? 'focused error' : ''}}">
                            <label>Seleccionar Condicion</label>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('type') ? 'focused error' : ''}}">
                            ...
                            <select name="type" class="form-control show-tick">
                                ...
                                <option value="apartment" {{ $property->type=='apartment' ? 'selected' : '' }}>Departamento</option>
                            </select>
                        </div>
                    </div>

                    <h5>Carcteristicas</h5>
            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="form-group form-float">
                        ...
                        <div class="help-info">Enlace de Youtube</div>
                    </div>
