...
@section('content')
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="header">
                    <h2>
                        {{$property->title}}
                        <br>
                        <small>Publicado por <strong>{{$property->user->name}}</strong> on {{$property->created_at->toFormattedDateString()}}</small>
                    </h2>
                </div>
            ...
            <div class="card">
                <div class="header">
                    <h2>{{ $property->comments_count }} Commentarios</h2>
                </div>
                <div class="body">
