...
@section('content')
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <h4 class="section-heading">Propiedades recomendadas</h4>
            </div>
            <div class="row">
                        ...
                        <div class="card">
                            <div class="card-image">
                                ...
                                @if($property->featured == 1)
                                    <a class="btn-floating halfway-fab waves-effect waves-light indigo" title="Recomendada"><i class="small material-icons">star</i></a>
                                @endif
                            </div>
                            ...
                            <div class="card-action property-action">
                                ...
                                <span class="btn-flat">
                                    <i class="material-icons">check_box</i>
                                    Area: <strong>{{ $property->area}}</strong> Mts cuadrados
                                </span>
                                <span class="btn-flat">
    ...
    <section class="section grey lighten-3 center">
        <div class="container">
            ...
            <h4 class="section-heading">Testimonios</h4>
    ...
    <section class="section center">
        <div class="row">
            <h4 class="section-heading">Novedades</h4>
        </div>
        <div class="container">
            <div class="row">
