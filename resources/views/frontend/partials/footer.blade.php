<footer class="page-footer indigo darken-2">
    <div class="container">
        <div class="row">
            <div class="col m4 s12">
                <h5 class="white-text uppercase">Sobre nosotros</h5>
                @if(isset($footersettings[0]) && $footersettings[0]['aboutus'])
                    <p class="grey-text text-lighten-4">{{ $footersettings[0]['aboutus'] }}</p>
                @else
                    <p class="grey-text text-lighten-4">Una inmobiliaria a su servicio.</p>
                @endif
            </div>
                    ...
                    @foreach($footerproperties as $property)
                        @if($property->featured == 1)
                            ...
                            <div class="float-left">
                                ...
                                <p class="m-t-0 m-b-5 grey-text text-lighten-1">Habitaciones: {{ $property->bedroom }} Baños: {{ $property->bathroom }} </p>
                            </div>
                            </li>
                        @endif
                    @endforeach
            ...
            <div class="col m2 s12">
                ...
                <ul>
                    ...
                    <li class="uppercase {{ Request::is('contact') ? 'underline' : '' }}">
                        <a href="{{ route('contact') }}" class="grey-text text-lighten-3">Contactos</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            @else
                © Publicar Propiedades 2022. Todos los derechos reservados.
            @endif
