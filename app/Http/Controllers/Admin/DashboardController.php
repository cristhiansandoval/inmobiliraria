...
class DashboardController extends Controller
{
    ...
    public function changePasswordUpdate(Request $request)
    {
        if (!(Hash::check($request->get('currentpassword'), Auth::user()->password))) {
            ...
            Toastr::error('message', '¡Su contraseña actual no coincide con la contraseña que proporcionó! Inténtelo de nuevo.');
            return redirect()->back();
        }
        if(strcmp($request->get('currentpassword'), $request->get('newpassword')) == 0){

            Toastr::error('message', '¡La nueva contraseña no puede ser la misma que su contraseña actual! Elija una contraseña diferente.');
            return redirect()->back();
        }
        ...
        Toastr::success('message', 'Clave modificada exitosamente.');
        return redirect()->back();
    }
    ...
    public function messageSend(Request $request)
    {
        ...
        Toastr::success('message', 'Mensaje enviado exitosamente.');
        return back();
    ...
    public function messageDelete($id)
    {
        ...
        Toastr::success('message', 'Mensaje eliminado exitosamente.');
        return back();
    }
    ...
    public function contactMail(Request $request)
    {
        ...
        Toastr::success('message', 'Correo enviado exitosamente.');
        return back();
    }
}
