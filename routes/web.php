...
Route::get('/agentsearch', 'FrontpageController@agentsearch')->name('agentsearch');
...
Route::group(['prefix'=>'admin','namespace'=>'Admin','middleware'=>['auth','admin'],'as'=>'admin.'], function(){
    ...
    Route::post('/pays','PayController@update')->name('pays.update');
    Route::post('/pays/store/{id}','PayController@store')->name('pays.store');
    Route::delete('/pays/delete/{id}','PayController@destroy')->name('pays.destroy');
